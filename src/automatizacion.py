...
for _, _ in df_final.iterrows():
    ...
    precio_ofertas = precio_cesta(lista_productos_cambiados, mercadona)
    precio_premium = precio_cesta(lista_productos_cambiados_baratos, mercadona)
    valor2 = ", ".join(cesta2)
    #print(valor)
    ...
    wks_final.update_cell(i,9 , precio_premium)
    wks_final.update_cell(i,10 , precio_ofertas)
